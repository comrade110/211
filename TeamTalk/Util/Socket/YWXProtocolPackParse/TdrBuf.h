...
/* creation time: Wed Jul 15 16:38:55 2015 */
...
class TdrWriteBuf
{
    ...
    public: /* write successively */
        ...
        TdrError::ErrorType writeInt16_l(const int16_t src)
        {
            return writeUInt16_l(*(uint16_t*)&src);
        }
        ...
        TdrError::ErrorType writeUInt16_l(const uint16_t src)
        {
            assert(position <= length);
            ...
            *(uint16_t*)(beginPtr + position) = src;
            position += sizeof(src);
        ...
        TdrError::ErrorType writeInt32_l(const int32_t src)
        {
            return writeUInt32_l(*(uint32_t*)&src);
        }
        ...
        TdrError::ErrorType writeUInt32_l(const uint32_t src)
        {
            assert(position <= length);
            ...
            *(uint32_t*)(beginPtr + position) = src;
            position += sizeof(src);
        ...
        TdrError::ErrorType writeInt64_l(const int64_t src)
        {
            return writeUInt64_l(*(uint64_t*)&src);
        }
        ...
        TdrError::ErrorType writeUInt64_l(const uint64_t src)
        {
            assert(position <= length);
            ...
            *(uint64_t*)(beginPtr + position) = src;
            position += sizeof(src);
        ...
        TdrError::ErrorType writeFloat_l(const float src)
        {
            TdrFUI32 f2i;
            f2i.f = src;
            return writeUInt32_l(f2i.i32);
        }
        ...
        TdrError::ErrorType writeDouble_l(const double src)
        {
            TdrDUI64 d2i;
            d2i.d = src;
            return writeUInt64_l(d2i.i64);
        }
    ...
    public: /* write directly */
        ...
        TdrError::ErrorType writeInt16_l(const int16_t src, size_t pos)
        {
            return writeUInt16_l((uint16_t)src, pos);
        }
        ...
        TdrError::ErrorType writeUInt16_l(const uint16_t src, size_t pos)
        {
            assert(position <= length);
        ...
        TdrError::ErrorType writeInt32_l(const int32_t src, size_t pos)
        {
            return writeUInt32_l((uint32_t)src, pos);
        }
        ...
        TdrError::ErrorType writeUInt32_l(const uint32_t src, size_t pos)
        {
            assert(position <= length);
        ...
        TdrError::ErrorType writeInt64_l(const int64_t src, size_t pos)
        {
            return writeUInt64_l((uint64_t)src, pos);
        }
        ...
        TdrError::ErrorType writeUInt64_l(const uint64_t src, size_t pos)
        {
            assert(position <= length);
        ...
        TdrError::ErrorType writeFloat_l(const float src, size_t pos)
        {
            TdrFUI32 f2i;
            f2i.f = src;
            return writeUInt32_l(f2i.i32, pos);
        }
        ...
        TdrError::ErrorType writeDouble_l(const double src, size_t pos)
        {
            TdrDUI64 d2i;
            d2i.d = src;
            return writeUInt64_l(d2i.i64, pos);
        }
...
class TdrReadBuf
{
    ...
    public: /* read successively */
        ...
        TdrError::ErrorType readInt16_l(int16_t& dest)
        {
            return readUInt16_l(*(uint16_t*)&dest);
        }
        ...
        TdrError::ErrorType readUInt16_l(uint16_t& dest)
        {
            assert(position <= length);
            ...
            dest = *(uint16_t*)(beginPtr + position);
            position += sizeof(dest);
        ...
        TdrError::ErrorType readInt32_l(int32_t& dest)
        {
            return readUInt32_l(*(uint32_t*)&dest);
        }
        ...
        TdrError::ErrorType readUInt32_l(uint32_t& dest)
        {
            assert(position <= length);
            ...
            dest = *(uint32_t*)(beginPtr + position);
            position += sizeof(dest);
        ...
        TdrError::ErrorType readInt64_l(int64_t& dest)
        {
            return readUInt64_l(*(uint64_t*)&dest);
        }
        ...
        TdrError::ErrorType readUInt64(uint64_t& dest)
        {
            ...
            memcpy(&dest, (beginPtr + position), sizeof(uint64_t));
            uint64_t temp = dest;
            unsigned char* p1 = (unsigned char*)&temp;
        ...
        TdrError::ErrorType readUInt64_l(uint64_t& dest)
        {
            assert(position <= length);
            ...
            dest = *(uint64_t*)(beginPtr + position);
            position += sizeof(dest);
        ...
        TdrError::ErrorType readFloat_l(float& dest)
        {
            TdrFUI32 i2f;
            TdrError::ErrorType ret = readUInt32_l(i2f.i32);
            if (TdrError::TDR_NO_ERROR == ret)
            {
                dest = i2f.f;
            }
        ...
        TdrError::ErrorType readDouble_l(double& dest)
        {
            TdrDUI64 i2d;
            TdrError::ErrorType ret = readUInt64_l(i2d.i64);
            if (TdrError::TDR_NO_ERROR == ret)
            {
                dest = i2d.d;
            }
    ...
    public: /* read directly */
        ...
        TdrError::ErrorType readInt16_l(int16_t& dest, size_t pos)
        {
            return readUInt16_l(*(uint16_t*)&dest, pos);
        }
        ...
        TdrError::ErrorType readUInt16_l(uint16_t& dest, size_t pos)
        {
            assert(position <= length);
        ...
        TdrError::ErrorType readInt32_l(int32_t& dest, size_t pos)
        {
            return readUInt32_l(*(uint32_t*)&dest, pos);
        }
        ...
        TdrError::ErrorType readUInt32_l(uint32_t& dest, size_t pos)
        {
            assert(position <= length);
        ...
        TdrError::ErrorType readInt64_l(int64_t& dest, size_t pos)
        {
            return readUInt64_l(*(uint64_t*)&dest, pos);
        }
        ...
        TdrError::ErrorType readUInt64(uint64_t& dest, size_t pos)
        {
            ...
            memcpy(&dest, (beginPtr + pos), sizeof(uint64_t));
            uint64_t temp = dest;
            unsigned char* p1 = (unsigned char*)&temp;
            unsigned char* p2 = (unsigned char*)&dest;
            for(int i=0; i<8; i++) {
        ...
        TdrError::ErrorType readUInt64_l(uint64_t& dest, size_t pos)
        {
            assert(position <= length);
        ...
        TdrError::ErrorType readFloat_l(float& dest, size_t pos)
        {
            TdrFUI32 i2f;
            TdrError::ErrorType ret = readUInt32_l(i2f.i32, pos);
            if (TdrError::TDR_NO_ERROR == ret)
            {
                dest = i2f.f;
            }
        ...
        TdrError::ErrorType readDouble_l(double& dest, size_t pos)
        {
            TdrDUI64 i2d;
            TdrError::ErrorType ret = readUInt64_l(i2d.i64, pos);
            if (TdrError::TDR_NO_ERROR == ret)
            {
                dest = i2d.d;
            }
