...
- (void)viewDidLoad
{
    ...
    FinderViewController *huodongVC =[[FinderViewController alloc] init];
    huodongVC.tabBarItem = [[UITabBarItem alloc] initWithTitle:@"活动" image:[UIImage imageNamed:@"tab_nav"] selectedImage:findSelected];
    huodongVC.tabBarItem.tag = 102;
    [huodongVC.tabBarItem setTitleTextAttributes:[NSDictionary dictionaryWithObject:RGB(26, 140, 242) forKey:NSForegroundColorAttributeName] forState:UIControlStateSelected];
    ...
    NSArray *nibs = [[NSBundle mainBundle] loadNibNamed:@"MyViewController" owner:self options:nil];
    MyViewController* myvc = nibs[0];
    ...
    self.viewControllers=@[recentVC,contactVC,findVC,huodongVC,myvc];
    self.delegate=self;
    self.title=APP_NAME;
